 ...
 */
package th.co.geniustree.nhso.drugcatalog.jsf;

/**
 * copy code from <a href="http://na5cent.blogspot.com/2014/05/spring-security-detect-primefaces-ajax.html">Spring security detect Primefaces ajax session expire.</a>
 * @author moth
 */
...
/**
 * Inspired by
 * <a href="http://stackoverflow.com/questions/10143539/jsf-2-spring-security-3-x-and-richfaces-4-redirect-to-login-page-on-session-tim">StackOverflow.com</a>
 * and by
 * <a href="http://www.icesoft.org/wiki/display/ICE/Spring+Security#SpringSecurity-Step4%3AConfigureYourSpringSecurityredirectStrategy">Spring
