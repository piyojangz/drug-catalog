 ...
 * @author Thanthathon
 */
public class TMTSubsToVtm implements Serializable, UploadRelationshipModel {

    @XlsColumn(columnNames = "STID")
    @NotEmpty
    private String parentTmtId;

    @XlsColumn(columnNames = "VTMID")
    @NotEmpty
    ...
    public boolean equals(Object obj) {
        ...
        final TMTSubsToVtm other = (TMTSubsToVtm) obj;
